...
class VideoGenerateRequest(BaseModel):
    ...
    duration: Optional[int] = Field(
        ...
        ge=5,
        le=15,
        description="视频目标时长（分钟）；手动可选 5-15 分钟，不传时由 AI 在 5-8 分钟内选择"
    )
    render_profile: RenderProfileName = Field(
        RenderProfileName.HD_1080P30,
        description="固定渲染规格：1920x1080/30fps",
    )
        ...
        json_schema_extra = {
            "example": {
                ...
                "data": {
                    ...
                    "warnings": [],
                    "requested_render_profile": "1080p30",
