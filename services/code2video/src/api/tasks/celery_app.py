...
VIDEO_TASK_QUEUE = os.getenv("VIDEO_TASK_QUEUE", "video_generation")
...
celery_app.conf.update(
    ...
    # 任务路由
    task_routes={
        "src.api.tasks.video_tasks.*": {"queue": VIDEO_TASK_QUEUE},
    },
    # 任务时间限制
    task_time_limit=settings.video_task_timeout_seconds,
    task_soft_time_limit=max(60, settings.video_task_timeout_seconds - 1800),
    # 结果后端配置
    result_backend_transport_options={
        "visibility_timeout": settings.video_task_timeout_seconds,
    },
)
...
celery_app.conf.task_queues = {
    VIDEO_TASK_QUEUE: {
        "exchange": VIDEO_TASK_QUEUE,
        "routing_key": VIDEO_TASK_QUEUE,
    },
}
