...
export async function getVisualization(id: string): Promise<StoredVisualizationResponse> {
  const response = await fetch(apiUrl(`/api/visualizations/${id}`));
...
export async function generateVisualization(
  ...
  const response = await fetch(apiUrl("/api/visualizations/generate"), {
    method: "POST",
...
export async function runVisualizationAgent(
  ...
  const response = await fetch(apiUrl(`/api/visualizations/${visualizationId}/agent`), {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export async function navigateHistory(
  ...
  const response = await fetch(apiUrl(`/api/visualizations/${visualizationId}/history`), {
    method: "POST",
    headers: { "Content-Type": "application/json" },
